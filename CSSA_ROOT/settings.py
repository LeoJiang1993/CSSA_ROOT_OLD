"""
Django settings for CSSA_ROOT project.
...
SECRET_KEY = 'q-lzd%o21pvy-ye)1b58715#^^=sx!_$4-q^2=m+^p2d-3@%7('
...
WSGI_APPLICATION = 'CSSA_ROOT.wsgi.application'
